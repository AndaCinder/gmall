package com.lichen.gmall.list.util;
 ...
 * 2019/10/24 - 22:56
 */
public class MatchQueryBuilderLiChen extends AbstractQueryBuilder<MatchQueryBuilder> {
...
//    public static final ParseField GENERATE_SYNONYMS_PHRASE_QUERY = new ParseField("auto_generate_synonyms_phrase_query", new String[0]);
    ...
    public MatchQueryBuilderLiChen(String fieldName, Object value) {
    ...
    public MatchQueryBuilderLiChen(StreamInput in) throws IOException {
        super(in);
        this.operator = DEFAULT_OPERATOR;
        this.fuzziness = null;
        this.prefixLength = 0;
    ...
    public MatchQueryBuilderLiChen operator(Operator operator) {
        if (operator == null) {
    ...
    public MatchQueryBuilderLiChen analyzer(String analyzer) {
    ...
    public MatchQueryBuilderLiChen fuzziness(Object fuzziness) {
    ...
    public MatchQueryBuilderLiChen prefixLength(int prefixLength) {
        if (prefixLength < 0) {
    ...
    public MatchQueryBuilderLiChen maxExpansions(int maxExpansions) {
        if (maxExpansions <= 0) {
    ...
    public MatchQueryBuilderLiChen cutoffFrequency(float cutoff) {
    ...
    public MatchQueryBuilderLiChen minimumShouldMatch(String minimumShouldMatch) {
    ...
    public MatchQueryBuilderLiChen fuzzyRewrite(String fuzzyRewrite) {
    ...
    public MatchQueryBuilderLiChen fuzzyTranspositions(boolean fuzzyTranspositions) {
    ...
    /** @deprecated */
    @Deprecated
    public MatchQueryBuilderLiChen setLenient(boolean lenient) {
        return this.lenient(lenient);
    }

    public MatchQueryBuilderLiChen lenient(boolean lenient) {
    ...
    public MatchQueryBuilderLiChen zeroTermsQuery(ZeroTermsQuery zeroTermsQuery) {
    ...
    public MatchQueryBuilderLiChen autoGenerateSynonymsPhraseQuery(boolean enable) {
...
//        builder.field(GENERATE_SYNONYMS_PHRASE_QUERY.getPreferredName(), this.autoGenerateSynonymsPhraseQuery);
    ...
    @Override
    protected boolean doEquals(MatchQueryBuilder matchQueryBuilder) {
        return false;
    }
